...
![Dos líneas ascendentes de población contra tiempo, con leyenda para cultivo_A y cultivo_B](assets/l23_linea.png){fig-alt="Gráfica de líneas donde cultivo A y cultivo B aumentan con el tiempo; cultivo A crece más rápido."}
...
![Tres barras de conteo total por especie; tilapia es la más alta](assets/l23_barra.png){fig-alt="Gráfica de tres barras con el conteo total por especie; tilapia tiene la barra más alta."}
...
![Puntos de absorbancia contra concentración que suben casi en línea recta](assets/l23_dispersion.png){fig-alt="Gráfica de dispersión donde la absorbancia aumenta casi linealmente con la concentración."}
...
![Histograma de lecturas de pH, con la mayoría de los valores cerca de 7.0](assets/l23_histograma.png){fig-alt="Histograma de pH con la mayor frecuencia de lecturas agrupada alrededor de siete."}
...
![Dos líneas sin título, sin rótulos de eje y sin leyenda](assets/l23_linea_sin_rotulos.png){fig-alt="Dos líneas ascendentes mostradas sin título, unidades, rótulos de eje ni leyenda."}
