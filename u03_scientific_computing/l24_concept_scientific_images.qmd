...
![Campo de microscopía simulado: fondo oscuro con siete células brillantes, con barra de intensidad](assets/l24_microscopia.png){fig-alt="Campo de microscopía simulado con siete células circulares brillantes sobre un fondo oscuro."}
...
![Acercamiento a una célula: el PNG conserva el cuadro uniforme; el JPEG lo deja con bordes y manchas](assets/l24_formatos.png){fig-alt="Comparación ampliada: PNG conserva una región uniforme y JPEG introduce bordes y manchas de compresión."}
...
![A la izquierda el campo original; a la derecha la máscara: las células en blanco sobre fondo negro](assets/l24_umbral.png){fig-alt="Comparación del campo de microscopía original con una máscara binaria de células blancas sobre fondo negro."}
...
![A la izquierda un gel con tres bandas; a la derecha su perfil de intensidad con la línea de umbral, cruzándola tres veces](assets/l24_gel.png){fig-alt="Gel con tres bandas y su perfil de intensidad, que cruza una línea de umbral tres veces."}
